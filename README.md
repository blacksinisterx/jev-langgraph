...
Same shape as the rest of the series: Vite static build for the frontend, FastAPI as Vercel Python serverless functions for the backend. No persistence beyond the in-memory run log.
